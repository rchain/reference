...
**Τι είναι το RChain;** \
Το RChain είναι μια θεμελιωδώς νέα πλατφόρμα blockchain βασισμένη σε ένα επίσημο μοντέλο ταυτόχρονου και αποκεντρωμένου υπολογισμού. Ο Συνεταιρισμός RChain αξιοποιεί αυτό το μοντέλο με την ανάπτυξη correct-by-construction λογισμικού ώστε να παράγει ένα παράλληλο, σύνθετο και άπειρα κλιμακωτό blockchain.
...
Το RChain ήταν το αποκορύφωμα μιας σειράς καινοτομιών από τον ιδρυτή του, τον Greg Meredith. Ο πυρήνας του RChain βασίζεται στον λογισμό κινητής επεξεργασίας, έναν κλάδο των μαθηματικών με περίπου 30 χρόνια ιστορίας. Μαζί με την εμπειρία άλλων blockchains και άλλων τεχνολογιών, η αρχιτεκτονική του RChain τεκμηριώθηκε τον Ιούλιο του 2016 και εκείνη την περίοδο, ο στόχος ήταν να δημιουργηθεί ένα κοινωνικό δίκτυο βασισμένο στο blockchain με ενσωματωμένη λειτουργία μικροπληρωμών, για παράδειγμα το attention economy. Λόγω της πολυπλοκότητας του έργου και διαφωνίας μεταξύ των μελών της ομάδας, αποφασίστηκε ότι ο Greg θα επικεντρωθεί στην πραγματοποίηση του οράματος του RChain. Ο οργανισμός RChain (ο [Συνεταιρισμός](https://www.rchain.coop/) και η [εταιρία Holdings](https://www.rchain.io)) ιδρύθηκαν το Δεκέμβριο του 2016 - Ιανουάριο 2017.

## Συνεταιρισμός

**Ποια είναι η διαφορά μεταξύ της εταιρείας Συνεταιρισμού και της εταιρίας Holdings;** \
...
Οι αξιωματικοί του Συνεταιρισμού είναι: Πρόεδρος, ο Greg Meredith. Γραμματέας, ο Evan Jensen. Ταμίας η Lisa Rice.

Υπάρχουν τρεις επιτροπές στις οποίες τα Μέλη συνεργάζονται για τη διαμόρφωση και οργάνωση του Συνεταιρισμού: της Εκτελεστικής Επιτροπής, της Επιτροπής Διακυβέρνησης και της Επιτροπής Αποζημίωσης. Όλες οι επιτροπές έχουν ανοιχτή συμμετοχή, αλλά ορισμένες περιορίζονται σε 11 εργαζόμενα Μέλη, συν μια θέση στην επιτροπή.
...
- Η εφαρμογή [zoom.us](https://zoom.us/) χρησιμοποιείται για τηλεδιασκέψεις όπως το Weekly Debrief της τετάρτης.
...
**Δεν μπορώ να ανεβάσω αρχεία στον ιστότοπο member.rchain.coop. Τι τρέχει;** \
Τα ονόματα αρχείων των εγγράφων ταυτότητάς σας δεν μπορούν να έχουν κενά ή ειδικούς χαρακτήρες. Χρησιμοποιήστε ονοματολογία παλαιότερων αρχείων όπως το 'passport.jpg' και προσπαθήστε να το ξανά ανεβάσετε.
...
Ναι. Διαβάστε το [CONTRIBUTING_GR.md](https://github.com/rchain/Members/blob/master/CONTRIBUTING_GR.md) και, στη συνέχεια, αναζητήστε τα έργα στα οποία θέλετε να συμμετάσχετε.


## Προγραμματιστές

**Τι είναι ο Λογισμός π;** \
"Στη θεωρητική επιστήμη των υπολογιστών, ο Λογισμός π είναι ένας υπολογισμός της διαδικασίας. Ο Λογισμός π επιτρέπει την επικοινωνία των ονομάτων των καναλιών κατά μήκος των ίδιων των καναλιών, και έτσι είναι σε θέση να περιγράψει ταυτόχρονους υπολογισμούς των οποίων η διαμόρφωση δικτύου μπορεί να αλλάξει κατά τη διάρκεια του υπολογισμού." (Αναφορικά: [https://el.wikipedia.org/wiki/%CE%9B%CE%BF%CE%B3%CE%B9%CF%83%CE%BC%CF%8C%CF%82_%CF%80](https://el.wikipedia.org/wiki/%CE%9B%CE%BF%CE%B3%CE%B9%CF%83%CE%BC%CF%8C%CF%82_%CF%80)). Για να κατανοήσετε καλύτερα τον τρόπο με τον οποίο εφαρμόζεται στην ανάπτυξη του RChain, ελέγξτε το επιστημονικό άρθρο [Mobile process calculi for programming the blockchain](http://mobile-process-calculi-for-programming-the-new-blockchain.readthedocs.io/en/latest/).

**Τι δεξιότητες χρειάζομαι για να συμμετάσχω;** \
Σε αυτό το σημείο, ολόκληρη η ανάπτυξη επικεντρώνεται στην βασική πλατφόρμα. Τα VM, η αποθήκευση και τα στρώματα δικτύωσης είναι όλα γραμμένα στη Scala. Τελικά θα υπάρχει κώδικας για το Casper, το πορτοφόλι REV και μερικά άλλα πράγματα στη Rholang. Εάν είστε έμπειρος προγραμματιστής με δεξιότητες της Scala τότε παρακαλούμε να έρθετε σε επαφή. Αργότερα θα χρειαστούν όλο και περισσότερες και ποικίλες δεξιότητες. Οι προγραμματιστές που είναι εξοικειωμένοι με άλλες γλώσσες, προγραμματιστές ιστού, σχεδιαστές, εμπειρογνώμονες JavaScript, διαχειριστές συστημάτων, δοκιμαστές beta και άτομα που εξασφαλίζουν την ποιότητα θα είναι στη ζήτηση. Αν θέλετε να συμμετάσχετε παρακαλούμε [εγγραφείτε ως Μέλος](https://member.rchain.coop) και τοποθετήστε τον εαυτό σας στην λίστα των ταλέντων
